    ...
    <div className="flex gap-8 max-md:gap-0 max-md:flex-col min-h-[inherit]">
      ...
      <div className="w-1/2 max-md:w-full flex flex-col max-md:mt-5 gap-5 max-lg:gap-3 max-md:gap-5">
        ...
        <button
          onClick={generateCharacter}
          disabled={isGenerating}
          className="max-md:hidden min-h-[70px] max-xl:min-h-[52px] w-full py-3 px-6 rounded-2xl bg-[#F45CFF] border-2 border-black shadow-[1px_3px_0px_3px_#000] uppercase text-white text-3xl max-xl:text-lg text-shadow-contur cursor-pointer"
        >
          {isGenerating ? 'Generating...' : 'Download your pfp'}
        </button>
      </div>
